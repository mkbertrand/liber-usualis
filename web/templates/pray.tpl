      ...
      <div id="bottom-easy-select-container">
        ...
        <div id="bottom-easy-select-content-container" x-show="bottomPanelOpen" x-transition>
          ...
          <div id="rite-selector-container">
            ...
            <a class="{{'rite-selector-button rite-selector-button-selected' if item[0] == occasion else 'rite-selector-button'}}" href="/{{locale}}/officium/{{pdate}}{{'' if select == 'primarium' else f'/{select}'}}/{{item[0]}}?v={{votives}}">{{item[1]}}</a>
            % end
          </div>
        </div>
      </div>
