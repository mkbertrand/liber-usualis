<div id="top-bar-title">
  ...
  % if options:
    <button id="rites-menu-toggle-wrapper" @click="ritesMenuOpen = !ritesMenuOpen">
      <svg id="rites-menu-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100%" height="100%"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M256 152c-48-32-128-32-176-8v240c48-24 128-24 176 8 48-32 128-32 176-8V144c-48-24-128-24-176 8Z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="32" d="M256 152v240"/></svg>
    </button>
