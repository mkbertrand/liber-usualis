...
<html lang="{{locale.split('-')[0]}}">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/resources/styles/{{page}}.css?v=21">
	...
	<body>
		<div id="site-wrapper" x-cloak x-data="{sidebarnavopen: false, locale: '{{locale}}'}">
			...
			% if page == 'pray':
				% include(f'web/resources/{page}.tpl', ritegenversion='15', text=json.load(open(f'web/locales/{locale}/pages/{page}.json')))
			% else:
