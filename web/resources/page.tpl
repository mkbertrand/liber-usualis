...
<html lang="{{locale.split('-')[0]}}">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/resources/styles/{{page}}.css?v=37">
...
@import url('https://fonts.googleapis.com/css2?family=Old+Standard+TT:ital,wght@0,400;0,700;1,400&display=swap');
	...
	<body>
		<div id="site-wrapper" x-cloak x-data="{sidebarnavopen: false, locale: '{{locale}}'}">
			...
			% if page == 'pray':
				% include(f'web/pages/{page}.tpl', ritegenversion='31', text=json.load(open(f'web/locales/{locale}/pages/{page}.json')))
			% else:
