...
class RiteRenderer:
    ...
    def render_gabc(
        ...
        elif isinstance(translation, list) and all(t is not None for t in translation):
            translation_string = html.escape(re.sub(r'\sV\.', " <span class='red'>&#8483;.</span>", ' '.join(translation)), quote=True)
        else:
            translation_string = ''
